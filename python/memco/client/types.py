...
class Tag:
    ...
    per-domain; :meth:`~memco.client.Client.list_domains` describes them.
...
class Memory:
    ...
    Attributes:
        ...
        reference: The handle an earlier search in the same session returned this
            ...
            :meth:`~memco.client.Client.get_memory` to read it again.
    """
...
class WriteResult:
    ...
    Attributes:
        operation_id: Handle addressing the write, for
            :meth:`~memco.client.Client.revert_memory`. ``None`` when no handle
