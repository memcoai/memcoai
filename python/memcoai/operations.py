...
class MemoryOperations:
    ...
    Reached as :attr:`~memcoai.Memco.memory`; not constructed directly.
...
class AsyncMemoryOperations:
    ...
    Reached as :attr:`~memcoai.AsyncMemco.memory`; not constructed
...
class Session:
    ...
    def search(
        ...
        *,
        ...
        Supply tags to narrow the results; :meth:`~memcoai.operations.MemoryOperations.list_domains`
    ...
    def create_memory(
        ...
        *,
        ...
        Each memory needs a query (what someone would search to find this), a title, and content
        describing what you learned. :meth:`~memcoai.operations.MemoryOperations.list_domains` says
    ...
    def tools(self) -> Toolset:
        ...
        """
        # Deferred: memcoai.agent reads this module to derive the descriptions and
...
class AsyncSession:
    ...
    async def search(
        ...
        *,
        ...
        :meth:`~memcoai.operations.AsyncMemoryOperations.list_domains` lists the tag types the
        chosen domain uses and the format they take.
    ...
    async def create_memory(
        ...
        *,
        ...
        Each memory needs a query (what someone would search to find this), a title, and content
        describing what you learned. :meth:`~memcoai.operations.AsyncMemoryOperations.list_domains`
