...
| [`langchain_agent.ts`](langchain_agent.ts)         | Wiring the memory tools into a LangChain agent                 |
...
`langchain_agent.ts` needs two packages the SDK does not install — LangChain and
